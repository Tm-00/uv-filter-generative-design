...
#SBATCH --job-name=reinforce_gpt2
#SBATCH --ntasks=1
#SBATCH --time=3:0:0
#SBATCH --qos=bbgpu
#SBATCH --gres=gpu:1
...
which python
python --version
python -u <YOUR_BASE_PATH>/code/acegen-chemical/scripts/reinforce/reinforce.py --config-path <YOUR_BASE_PATH>/experiments --config-name config_denovo
