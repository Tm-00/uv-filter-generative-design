...
which python
python --version
python -u <YOUR_BASE_PATH>/code/acegen-chemical/scripts/reinforce/norl.py --config-path <YOUR_BASE_PATH>/experiments --config-name config_denovo
